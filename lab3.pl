...
%Выполнить указанную задачу с помощью рекурсии вверх и рекурсии вниз.
min(N,N):-N<10.
...
kol_del(1,_,1):-!.
kol_del(I,N,Count):-I1 is I-1, kol_del(I1,N,C), (0 is N mod I ->  write(I),nl, Count is C+1;Count is C).
